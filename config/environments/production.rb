OnlineEdu::Application.configure do
  ...
  config.assets.precompile += %w(bootstrap-datetimepicker.min.css event_calendar.css style.css youTubeEmbed-jquery-1.0.css bootstrapx-clickover.js event_calendar.js youTubeEmbed-jquery-1.0.js shortcut.js jquery.swfobject.1-1-1.min.js modules/exporting.js bootstrap-datetimepicker.min.js inflection.js jquery.nestedAccordion.js nicEdit.js)
